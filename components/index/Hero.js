...
function Hero() {
  return (
    <div className='mt-8 grid grid-cols-1 md:grid-cols-2 items-center justify-between gap-x-4 rounded-3xl
                     bg-slate-100  px-8 md:pl-24 py-16 gap-y-8 relative'>
        <div className='flex flex-col items-start gap-y-8'>
            ...
            <div className='flex flex-row gap-x-4 lg:gap-x-6 items-center'>
                <div className=' hover:scale-110 hover:shadow-xl cursor-pointer flex flex-row items-center gap-x-4 p-2
                                transform duration-200 lg:px-6 lg:py-2 bg-white rounded-lg shadow-md shadow-[#EFEAE5]'>
                    <Image
                        src='/img/apple.png'
                        width={200}
                        height={200}
                ...
                <div className='hover:scale-110 hover:shadow-xl cursor-pointer flex flex-row items-center gap-x-4 p-2]
                                transform duration-200 p-2 lg:px-6 lg:py-2 bg-white rounded-lg shadow-md shadow-[#EFEAE5]'>
                    <Image
