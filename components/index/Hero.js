...
function Hero() {
  return (
    <div className='mt-8 grid grid-cols-1 md:grid-cols-2 items-center justify-between gap-x-4 rounded-3xl border border-slate-200  bg-slate-100/50 px-8 md:pl-24 py-16 gap-y-8 relative'>
