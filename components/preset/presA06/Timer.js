    ...
    <div className='w-full flex flex-col items-center justify-center bg-cover bg-center mb-8 px-12 gap-y-8 text-slate-800 relative'>
        ...
        <h1 className={'text-2xl  '+fadeUp}>SAVE THE DATE</h1>
         <div className={'grid grid-cols-4 gap-8 '+fadeUp}>
          ...
          <button onClick={saveDate} className='text-white fadeUp flex flex-row items-center justify-center text-sm rounded-full gap-2 border bg-[#94A7C0] border-white px-4 py-2 mt-8
