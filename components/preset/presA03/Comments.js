...
export default function Comments({slug,url,tamu}) {
    ...
    return (
        <div id='doa' className='w-full bg-white p-6 flex flex-col items-center gap-y-2 px-8 text-[#3c3838]'>
            ...
            <div className='w-full flex flex-col items-center justify-start space-y-3  rounded-xl p-4 text-black text-sm max-h-[600px] lg:max-h-[700px] overflow-y-scroll'>
                {comments.map(comment => (
                    <div key={comment.Comment_Id} className='w-full flex flex-col items-start justify-start space-y-4 bg-[#e4e4df] text-slate-900 rounded-lg py-4 px-8'>
